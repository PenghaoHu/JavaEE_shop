...
function loadContent(url){
	var html = '<iframe class="LRADMS_iframe" width="100%" height="100%" src="<%=basePath %>';
	html += url;
	html += '.jsp" frameborder="0" data-id="default.jsp"></iframe>';
...
<body class="hold-transition skin-blue sidebar-mini"
	...
	<div class="wrapper">
		...
		<header class="main-header"> <nav
			class="navbar navbar-static-top"> <a class="sidebar-toggle">
				...
				<li class="dropdown user user-menu"><a href="#"
					...
					<ul class="dropdown-menu pull-right">
						<li><a class="menuItem" data-id="userInfo"
							href="<%=basePath%>jsp/updateUserMsg.jsp"><i
		...
		<div id="content-wrapper" class="content-wrapper">
			<div class="content-iframe" style="overflow: hidden;">
				<div class="mainContent" id="content-main"
					...
					<iframe class="LRADMS_iframe" width="100%" height="100%" src=""
						frameborder="0" data-id="default.jsp"></iframe>
				</div>
			</div>
		</div>
	</div>
